(function (global, factory) {
	...
	var initStore = function initStore() {
	  var isMounted = lodash_get(window, __MOUNT_PROPERTY__);

	  if (isMounted) {
	    return;
	  }

	  lodash_set(window, __MOUNT_PROPERTY__, {});
	};
	...
	***************************************************************************** */
	...
	var _isEqual = lodash_isequal.exports;
	...
	var getStore = function getStore() {
	  return lodash_get(window, __MOUNT_PROPERTY__) || {};
	};
	var getStoreValue = function getStoreValue(key) {
	  var store = getStore();
	  return lodash_get(store, key);
	};
