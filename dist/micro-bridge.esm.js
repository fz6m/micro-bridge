...
var initStore = function initStore() {
  var isMounted = _get2(window, __MOUNT_PROPERTY__);

  if (isMounted) {
    return;
  }

  _set2(window, __MOUNT_PROPERTY__, {});
};
...
var dispatchValueSubscribes = function dispatchValueSubscribes(_a) {
  ...
  if (!_isEqual2(oldValue, newValue)) {
    // dispatch all
...
var getStore = function getStore() {
  return _get2(window, __MOUNT_PROPERTY__) || {};
};
...
var setStoreValue = function setStoreValue(key, value) {
  ...
  _set2(store, key, value); // dispatch value change
...
export { Store, StoreBus, StoreChange };
